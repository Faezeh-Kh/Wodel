...
public class WodelGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class BlockElements extends AbstractParserRuleElementFinder {
		...
		//Block returns Block:
		//    name=ID (description=EString)? ('from' from+=[Block|ID] (',' from+=[Block|ID])*)? ('repeat' '=' repeat=Repeat)? '{' commands+=Mutator (commands+=Mutator)* '}' ('[' (min=EInt '..' max=MaxCardinality | fixed=EInt) ']')?
		//;
		@Override public ParserRule getRule() { return rule; }
